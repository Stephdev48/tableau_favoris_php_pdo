...
<?php
    echo "<h2 class='text-3xl text-center m-40 font-bold'>Votre favori a bien été supprimé de la base de données.<br>Vous allez être redirigé dans 5 secondes...</h2>";
