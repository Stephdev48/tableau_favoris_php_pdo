...
<fieldset class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-6 p-8 border-solid border-black border-2 bg-stone-200 m-10 rounded-2xl">
    ...
    <h2 class="ml-14 text-xl font-bold text-center"><?php print_r($single_fav["libelle"]);?></h2>
    <p class="ml-12 mr-12 text-lg font-bold text-center">Favori créé le : <br><span class="text-base font-medium"><?php print_r($single_fav["date_creation"]);?></span></p>
    <div class="flex justify-center">
        <div class="flex-col text-lg font-bold">
            <h3 class="mb-2">Lien</h3>
            <?php echo "<a href='".$single_fav['url']."' target='about_blank'><img src='images/link-solid.svg' width='35px' class='bg-teal-400 hover:bg-teal-500 rounded-lg p-1'/></a>";?>
        </div>
    </div>
    <div class="flex justify-center">
