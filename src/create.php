    ...
    <form action="" method="post" class="text-center">
        <ul class="flex-col m-20">
            ...
            <li class="flex-col m-2">
                ...
                <input type="text" id="nom" name="nom" class="rounded-md" required></input>
            </li>
            ...
            <li class="flex-col m-6">
                ...
                <select class="cursor-pointer hover:bg-slate-100 hover:shadow-xl rounded-lg" id="cat" name="cat[]" multiple>
